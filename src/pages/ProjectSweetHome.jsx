    ...
    <article>
      ...
      <div className="mx-auto max-w-3xl px-6 pb-24 md:px-10">
        ...
        <Section title="Protection des données">
          <p>
            <strong>Ce qui est enregistré :</strong> adresse e-mail, nom
            affiché, foyers et rôles, contenu des listes, prix et dates
            d'achat. Une liste peut contenir des noms de médicaments, ce
            qui la rend plus sensible qu'une simple liste alimentaire.
          </p>
          <p>
            <strong>Le principe que j'ai suivi :</strong> une maison ne
            doit jamais voir les données d'une autre. Cette règle n'est pas
            écrite dans l'application, mais dans la base de données
            elle-même. La différence compte : le code de l'application est
            téléchargé par le téléphone de chaque utilisateur, donc lisible
            et modifiable par une personne motivée. La base, elle, reste
            sur le serveur. Même quelqu'un qui contournerait complètement
            l'application pour interroger la base directement n'obtiendrait
            rien d'une autre maison.
          </p>
          <p>
            <strong>Ce que j'ai mis en place :</strong>
          </p>
          <ul>
            <li>
            ...
            <li>
              les codes d'invitation comptent 8 chiffres, expirent au bout
              de 5 minutes et ne servent qu'une fois ;
            </li>
            <li>
