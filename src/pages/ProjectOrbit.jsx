  ...
  return (
    <article>
      <CaseStudyHero
        ...
        demo={{ email: "test@orbit.com", password: "-J?6e.4$-5hN7BM" }}
      />
      ...
      <div className="mx-auto max-w-3xl px-6 pb-24 md:px-10">
        ...
        <Section title="Ce que fait l'application">
          <ul>
            ...
            <li>
              L'application indique chaque jour les personnes à recontacter
              en priorité.
            </li>
            <li>
            ...
            <li>Un espace de notes permet de garder l'essentiel de chaque échange.</li>
        ...
        <Section title="Comment c'est construit">
          <p>
            ...
            sont envoyés par une tâche qui s'exécute automatiquement chaque
            jour sur le serveur.
          </p>
          <p>
            <strong>Une précision honnête sur l'origine du projet :</strong>{" "}
            Orbit a démarré sur Lovable, un outil qui génère une première
            version d'application à partir d'une description écrite. Cette
            base générée explique le choix initial des technologies, que
            je n'ai donc pas arbitré moi-même. Je l'ai ensuite reprise en
            profondeur : vue 3D, notifications, calendriers personnalisés,
            et remplacement des éléments de connexion qui dépendaient
            encore du compte Lovable et non du mien.
          </p>
        </Section>

        <Section title="Protection des données">
          <p>
            <strong>Ce qui est enregistré :</strong> noms des contacts,
            catégories, notes libres, dates du dernier échange et motifs de
            rappel. Pour envoyer les notifications, l'application conserve
            aussi un identifiant de l'appareil.
          </p>
          <p>
            <strong>Le point le plus délicat.</strong> Orbit contient des
            informations sur des personnes qui n'ont jamais donné leur
            accord : mes proches ignorent qu'ils figurent dans une base de
            données avec des notes les concernant. Le RGPD prévoit une
            exception pour un usage strictement personnel, qui couvre
            l'usage actuel de l'application. Cette exception disparaîtrait
            si j'ouvrais l'application au public. Je dois par ailleurs
            vérifier dans quelle région Supabase héberge ces données, pour
            savoir si elles restent en Europe.
          </p>
          <p>
            <strong>Le cloisonnement entre comptes</strong> repose, comme
            sur SweetHome, sur des règles inscrites dans la base
            elle-même : chaque personne ne voit que ses propres contacts,
            et cette règle s'applique même à quelqu'un qui contournerait
            l'application.
          </p>
        </Section>
        ...
        <Section title="Ce que ce projet m'a appris sur la sécurité">
          <Callout icon={KeyRound} label="Incident corrigé">
            <p>
              ...
              fuite pas seulement par du code mal configuré, mais aussi par
              une fenêtre de discussion ou une capture d'écran.
            </p>
            <p>
              <strong>D'anciennes clés restent dans l'historique du
              projet.</strong> Un fichier de configuration a été enregistré
              avant que je pense à l'exclure. Exclure un fichier ne
              l'efface pas des versions déjà enregistrées : il faut
              nettoyer l'historique. C'est pour cette raison que je ne
              publie pas encore le code de ce projet.
            </p>
            <p>
              <strong>Je ne contrôlais pas ma propre
              authentification.</strong> La connexion par compte Google
              reposait sur les identifiants de Lovable, pas sur les miens.
              Une partie du parcours de connexion de mes utilisateurs
              dépendait donc d'un tiers, sans que j'en aie conscience,
        ...
        <Section title="Une panne instructive">
          <Callout icon={ServerCrash} label="Panne résolue">
            <p>
              ...
              avait été mise en pause après une période sans activité, puis
              supprimée. J'ai dû tout reconfigurer. Depuis, je considère la
              disponibilité d'un service gratuit comme une hypothèse à
              surveiller, pas comme un acquis.
            </p>
            <p>
              Autre incident : certaines planètes s'affichaient parfaitement
              chez moi mais devenaient invisibles une fois le site en
              ligne. L'outil de mise en forme supprime automatiquement les
              styles qu'il croit inutilisés, et les couleurs des planètes
              étaient construites au dernier moment, donc indétectables
              pour lui. Ni erreur, ni avertissement : j'ai trouvé la cause
              en inspectant le fichier de styles final.
            </p>
          </Callout>
        </Section>
      </div>
